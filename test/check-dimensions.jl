function check_nlp_dimensions(nlp; exclude_hess=false)
  ...
  if m > 0
    ...
    if !exclude_hess
      ...
      @test_throws DimensionError jth_hprod!(nlp, badx, v, m, Hv)
      @test_throws DimensionError jth_hprod!(nlp, x, badv, m, Hv)
      @test_throws AssertionError jth_hprod!(nlp, x, v, m + 1, Hv)
      ...
      @test_throws DimensionError jth_hess_coord!(nlp, badx, hvals)
      @test_throws DimensionError jth_hess_coord!(nlp, x, badhvals)
