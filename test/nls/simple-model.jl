...
function NLPModels.jac_structure_residual!(
  nls::SimpleNLSModel, rows::AbstractVector{<:Integer}, cols::AbstractVector{<:Integer}
)
...
function NLPModels.jac_coord_residual!(
  nls::SimpleNLSModel, x::AbstractVector, vals::AbstractVector
)
  @lencheck 2 x
  @lencheck 3 vals
...
function NLPModels.jprod_residual!(
  nls::SimpleNLSModel, x::AbstractVector, v::AbstractVector, Jv::AbstractVector
)
  @lencheck 2 x v Jv
...
function NLPModels.jtprod_residual!(
  nls::SimpleNLSModel, x::AbstractVector, v::AbstractVector, Jtv::AbstractVector
)
  @lencheck 2 x v Jtv
...
function NLPModels.hess_coord_residual!(
  nls::SimpleNLSModel, x::AbstractVector, v::AbstractVector, vals::AbstractVector
)
  @lencheck 2 x v
  @lencheck 1 vals
...
function NLPModels.hprod_residual!(
  nls::SimpleNLSModel, x::AbstractVector, i::Int, v::AbstractVector, Hiv::AbstractVector
)
  @lencheck 2 x v Hiv
...
function NLPModels.hess(
  nls::SimpleNLSModel, x::AbstractVector{T}, y::AbstractVector{T}; obj_weight=1.0
) where {T}
  @lencheck 2 x
  @lencheck 3 y
  increment!(nls, :neval_hess)
...
function NLPModels.hess_structure!(
  nls::SimpleNLSModel, rows::AbstractVector{Int}, cols::AbstractVector{Int}
)
  @lencheck 3 rows cols
  n = nls.meta.nvar
...
function NLPModels.hess_coord!(
  nls::SimpleNLSModel, x::AbstractVector, vals::AbstractVector; obj_weight=1.0
)
  @lencheck 2 x
  @lencheck 3 vals
