...
function test_breakage_deploy()
  ...
  packages = ["NLPModelsModifiers", "NLPModelsTest", "ADNLPModels", "AmplNLReader", "CUTEst", "LLSModels", "NLPModelsJuMP", "PDENLPModels", "QuadraticModels", "SolverTools", "CaNNOLeS", "JSOSolvers", "NLPModelsIpopt", "Percival", "DCI"]
