...
function NLPModels.hess_structure!(
  nlp::SimpleNLPModel, rows::AbstractVector{Int}, cols::AbstractVector{Int}
)
...
function NLPModels.jprod!(
  nlp::SimpleNLPModel, x::AbstractVector, v::AbstractVector, Jv::AbstractVector
)
  @lencheck 2 x v Jv
...
function NLPModels.jtprod!(
  nlp::SimpleNLPModel, x::AbstractVector, v::AbstractVector, Jtv::AbstractVector
)
  @lencheck 2 x v Jtv
...
function NLPModels.jth_hess_coord!(
  nlp::SimpleNLPModel, x::AbstractVector{T}, j::Integer, vals::AbstractVector{T}
) where {T}
  @lencheck 2 x vals
