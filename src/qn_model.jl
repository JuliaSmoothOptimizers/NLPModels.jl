...
hess_op(nlp :: QuasiNewtonModel, x :: AbstractVector{Float64}; kwargs...) = nlp.op
hprod(nlp :: QuasiNewtonModel, x :: AbstractVector{Float64}, v :: AbstractVector{Float64}; kwargs...) = nlp.op * v
function hprod!(nlp :: QuasiNewtonModel, x :: AbstractVector{Float64},
                v :: AbstractVector{Float64}, Hv :: AbstractVector{Float64}; kwargs...)
