...
function NLPModelsCore.``F(x,s) = c(x) - s``:
```math
\\begin{aligned}
...
function NLPModelsCore.residual!(nls :: FeasibilityResidual, x :: AbstractVector, Fx :: AbstractVector)
...
function NLPModelsCore.jac_residual(nls :: FeasibilityResidual, x :: AbstractVector)
  increment!(nls, :neval_jac_residual)
  return jac(nls.nlp, x)
end

function NLPModelsCore.jac_structure_residual!(nls :: FeasibilityResidual, rows :: AbstractVector{<: Integer}, cols :: AbstractVector{<: Integer})
  return jac_structure!(nls.nlp, rows, cols)
end

function NLPModelsCore.jac_coord_residual!(nls :: FeasibilityResidual, x :: AbstractVector, vals :: AbstractVector)
  increment!(nls, :neval_jac_residual)
  return jac_coord!(nls.nlp, x, vals)
end

function NLPModelsCore.jprod_residual!(nls :: FeasibilityResidual, x :: AbstractVector, v :: AbstractVector, Jv :: AbstractVector)
  increment!(nls, :neval_jprod_residual)
  return jprod!(nls.nlp, x, v, Jv)
end

function NLPModelsCore.jtprod_residual!(nls :: FeasibilityResidual, x :: AbstractVector, v :: AbstractVector, Jtv :: AbstractVector)
  increment!(nls, :neval_jtprod_residual)
  return jtprod!(nls.nlp, x, v, Jtv)
end

function NLPModelsCore.hess_residual(nls :: FeasibilityResidual, x :: AbstractVector, v :: AbstractVector)
  increment!(nls, :neval_hess_residual)
  return hess(nls.nlp, x, v, obj_weight = 0.0)
end

function NLPModelsCore.hess_structure_residual!(nls :: FeasibilityResidual, rows :: AbstractVector{<: Integer}, cols :: AbstractVector{<: Integer})
  return hess_structure!(nls.nlp, rows, cols)
end

function NLPModelsCore.hess_coord_residual!(nls :: FeasibilityResidual, x :: AbstractVector, v :: AbstractVector, vals :: AbstractVector)
  increment!(nls, :neval_hess_residual)
  return hess_coord!(nls.nlp, x, v, vals, obj_weight=0.0)
end

function NLPModelsCore.jth_hess_residual(nls :: FeasibilityResidual, x :: AbstractVector, i :: Int)
...
function NLPModelsCore.hprod_residual!(nls :: FeasibilityResidual, x :: AbstractVector, i :: Int, v :: AbstractVector, Hiv :: AbstractVector)
...
function NLPModelsCore.hess(nls :: FeasibilityResidual, x :: AbstractVector; obj_weight :: Real=one(eltype(x)))
...
function NLPModelsCore.hprod!(nls :: FeasibilityResidual, x :: AbstractVector, v :: AbstractVector, Hv :: AbstractVector; obj_weight :: Real=one(eltype(x)))
  increment!(nls, :neval_hess)
  cx = cons(nls.nlp, x)
