...
function hess(nls :: ADNLSModel, x :: AbstractVector; obj_weight = 1.0, y :: AbstractVector = [])
...
function hess_coord(nls :: ADNLSModel, x :: AbstractVector; obj_weight = 1.0, y :: AbstractVector = [])
