...
| ``c(x)``            | [`cons`](@ref), [`cons!`](@ref), [`cons_lin!`](@ref), [`cons_nln!`](@ref), [`objcons`](@ref), [`objcons!`](@ref) |
| ``J(x)``            | [`jac`](@ref), [`jac_op`](@ref), [`jac_op!`](@ref), [`jac_coord`](@ref), [`jac_coord!`](@ref), [`jac_coord_lin!`](@ref), [`jac_coord_nln!`](@ref), [`jprod`](@ref), [`jprod!`](@ref), [`jprod_lin!`](@ref), [`jprod_nln!`](@ref), [`jtprod`](@ref), [`jtprod!`](@ref) |
